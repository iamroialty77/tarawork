...
export default function Messaging({
  ...
  return (
    <div className="flex h-[600px] bg-white rounded-2xl overflow-hidden border border-slate-100 shadow-2xl shadow-slate-200/50">
                ...
                <div>
                  ...
                  <div className="flex items-center gap-2">
                    ...
                    <p className="text-[10px] text-slate-400 font-bold uppercase tracking-wider">
                      {selectedConversation.other_participant?.role === 'employer' ? 'Employer' : 'Freelancer'}
                    </p>
                  </div>
                </div>
              </div>
                  ...
                  <div className="p-4 max-h-[400px] overflow-y-auto space-y-2">
                    {employerJobs.length > 0 ? (
                      ...
                      <div className="text-center py-8">
                        <p className="text-sm text-slate-500">You don't have any active job postings yet.</p>
                        <button 
